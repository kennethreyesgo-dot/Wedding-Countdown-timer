...
const App: React.FC = () => {
  ...
  return (
    ...
    >
      ...
      {/* Subtle Settings Toggle (Visible on hover/tap) */}
      <button 
        onClick={() => setIsSettingsOpen(true)}
        className="absolute bottom-4 right-4 z-40 p-2 text-white/30 hover:text-white/80 transition-all opacity-0 hover:opacity-100"
        title="Settings"
      >
